...
//     }
    ...
    //init tabs plugin
    var productTabs = $(".single-page-tabs__tabs");
    ...
    //spoilers
    var linkOpenDescFaq = $(".button-spoiler");
    linkOpenDescFaq.on("click", function (e) {

        var spoilerDesc = $(this).closest("li").find(".list-spoilers__desc");
        spoilerDesc.stop().slideToggle(300);

        var openBtnSpoiler = $(this).closest("li").find(".list-spoilers__button");
        var openBtnIcon = $(this).closest("li").find(".list-spoilers__button-icon");

        if (!$(this).hasClass('list-spoilers__button_active')) {
